      ...
      <div className="relative w-full max-w-lg bg-white rounded-sm shadow-2xl border border-[#7E2562]/15 overflow-hidden transition-all transform animate-scaleUp">
        ...
        <div className="bg-gradient-to-r from-[#7E2562] via-[#651D4E] to-[#4F143D] text-white p-6 sm:p-8 relative overflow-hidden">
          ...
          <h2 className="text-2xl sm:text-3xl font-serif font-bold text-white">
            {mode === "login" ? "Welcome Back, Author" : "Publish With Kairali Books"}
          </h2>
        ...
        <div className="p-6 sm:p-8">
          {errorMsg && (
            <div className="mb-5 p-3.5 rounded-sm bg-red-50 border border-red-200 text-red-700 text-xs flex items-start gap-2.5">
          ...
          {mode === "login" ? (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <a
                    href="mailto:submissions@kairalibooks.com?subject=Author%20Password%20Reset%20Request"
                    className="text-xs text-[#7E2562] hover:underline"
                  >
                    Forgot password?
                  </a>
                </div>
              ...
              <button
                ...
                className="w-full py-3.5 px-4 rounded-sm bg-[#7E2562] hover:bg-[#681E51] text-white text-sm font-bold shadow-md shadow-[#7E2562]/20 flex items-center justify-center gap-2 transition-all hover:scale-[1.01] disabled:opacity-50 mt-2"
              >
                {isSubmitting ? (
                  <>
              ...
              <div className="pt-4 border-t border-neutral-100 text-center">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-sm border border-[#7E2562]/30 text-[#7E2562] hover:bg-[#FAF5F8] text-xs font-bold transition-all flex items-center justify-center gap-1.5"
                >
            ...
            /* MODE 2: SIGNUP CONFIRMATION / GATEWAY CARD */
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                <button
                  type="button"
                  onClick={goToOnboarding}
                  className="w-full py-3.5 px-4 rounded-sm bg-[#7E2562] hover:bg-[#681E51] text-white text-sm font-bold shadow-lg shadow-[#7E2562]/20 flex items-center justify-center gap-2 transition-all hover:scale-[1.01]"
                >
              ...
              <div className="pt-3 border-t border-neutral-100 text-center">
                <button
                  ...
                  className="text-xs text-neutral-500 hover:text-[#7E2562] transition-colors"
                >
