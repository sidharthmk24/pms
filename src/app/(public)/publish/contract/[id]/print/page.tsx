...
export const metadata: Metadata = {
  title: "Publishing Agreement (Official PDF) · Kairali Books",
};
export const dynamic = "force-dynamic";

export default async function PublicContractPrintPage({
  params,
}: {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 p-8 sm:p-12 max-w-4xl mx-auto printable-contract">
      <PrintTrigger contractId={id} />
      ...
      <div className="space-y-6 text-[11.5pt] leading-relaxed">
        ...
        <div className="parties-box border border-gray-300 bg-gray-50/75 rounded-lg p-4 font-sans text-xs space-y-2">
          <p>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <p>
              Copyright in the text and literary content remains solely with the Author &copy; {new Date().getFullYear()} {contract.authors.name}. If the Work remains out of print for a continuous period of 12 months after written demand by the Author, all publishing rights shall revert to the Author.
            </p>
          </div>
        ...
        <div className="pt-8 mt-8 border-t-2 border-gray-900 grid grid-cols-2 gap-8 font-sans break-inside-avoid">
          ...
          <div className="signature-box border border-gray-300 rounded-xl p-5 bg-gray-50/75 flex flex-col justify-between">
            <div>
