...
export const STATUS_BADGE_MAP: Record<string, { label: string; className: string }> = {
  ...
  under_review: { label: "Under Review", className: "bg-amber-50 text-amber-800 border-amber-300 font-bold" },
  in_review: { label: "Under Review", className: "bg-amber-50 text-amber-800 border-amber-300 font-bold" },
