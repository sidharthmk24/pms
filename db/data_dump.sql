...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.users (id, email, name, password_hash, role, active, created_at) FROM stdin;
...
--
-- Data for Name: audit_log; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.audit_log (id, user_id, action, entity, entity_id, detail, at) FROM stdin;
...
--
-- Data for Name: authors; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.authors (id, name, name_ml, phone, email, address, pan, notes, created_at) FROM stdin;
...
--
-- Data for Name: titles; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.titles (id, isbn, name, name_ml, author_id, category, language, edition, edition_no, parent_title_id, mrp_paise, unit_cost_paise, pages, binding, reorder_level, stock, status, created_at) FROM stdin;
...
--
-- Data for Name: contracts; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.contracts (id, title_id, author_id, royalty_pct, basis, advance_paise, signed_on, term_notes, created_at) FROM stdin;
...
--
-- Data for Name: counters; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--
...
--
-- Data for Name: dealers; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.dealers (id, name, contact, phone, gstin, address, discount_pct, credit_limit_paise, created_at) FROM stdin;
...
--
-- Data for Name: email_outbox; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.email_outbox (id, to_email, to_name, subject, body_text, body_html, template, ref_type, ref_id, status, attempts, last_error, created_at, sent_at) FROM stdin;
...
--
-- Data for Name: login_attempts; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.login_attempts (email, failed_count, first_failed_at, last_failed_at, locked_until) FROM stdin;
\.


--
-- Data for Name: payouts; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.payouts (id, author_id, gross_paise, tds_paise, net_paise, paid_on, method, reference, note, created_by, created_at) FROM stdin;
\.


--
-- Data for Name: print_jobs; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.print_jobs (id, job_no, title_id, qty, paper, binding, vendor, cost_paise, status, raised_on, received_on, notes, created_by, created_at) FROM stdin;
...
--
-- Data for Name: production_projects; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.production_projects (id, title_id, status, dtp_assigned_to, dtp_deadline, dtp_completed_at, editing_assigned_to, editing_deadline, editing_completed_at, cover_assigned_to, cover_deadline, cover_completed_at, isbn_assigned_to, isbn_deadline, isbn_completed_at, isbn_registered, proof_assigned_to, proof_deadline, proof_completed_at, proof_feedback, proof_approved_at, print_job_id, print_completed_at, created_at, updated_at, final_layout_path, final_cover_path) FROM stdin;
...
--
-- Data for Name: sales; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.sales (id, doc_no, type, channel, dealer_id, customer_name, event_name, discount_pct, subtotal_paise, discount_paise, total_paise, payment_mode, sold_on, return_of_sale_id, notes, created_by, created_at) FROM stdin;
...
--
-- Data for Name: sale_lines; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.sale_lines (id, sale_id, title_id, qty, unit_price_paise, discount_pct, line_total_paise) FROM stdin;
...
--
-- Data for Name: sessions; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--
...
--
-- Data for Name: settings; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--
...
--
-- Data for Name: stock_movements; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.stock_movements (id, title_id, qty_delta, reason, ref_type, ref_id, balance_after, note, user_id, at) FROM stdin;
...
--
-- Data for Name: submission_throttle; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.submission_throttle (ip_hash, count, window_start, last_at) FROM stdin;
\.


--
-- Data for Name: submissions; Type: TABLE DATA; Schema: public; Owner: mm-developer01
--

COPY public.submissions (id, ref_no, author_name, author_name_ml, email, phone, place, title, title_ml, genre, language, synopsis, manuscript_path, manuscript_filename, manuscript_size, manuscript_mime, status, source, reviewed_by, review_notes, decided_on, submitted_at, updated_at, publishing_type, assigned_at) FROM stdin;
